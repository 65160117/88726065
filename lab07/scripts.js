...
function toggleComplete(index) {
    ...
    // Code หน้า todo.html ทำหน้าที่เป็นหน้าเว็บไซต์ ที่มีข้อมูลที่เราใส่ไป
    // styles.css ทำหน้าที่ เปลี่ยนให้รูปแบบของเว็บไซต์สวยงามตามที่เราต้องการขึ้น
    // scripts.js ทำหน้าที่ กำหนดให้ปุ่มที่เราสร้างขึ้นมาในหน้า todo.html ให้ทำงานอย่างไรด้วย funtion